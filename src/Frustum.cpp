...
void Frustum::NormalizePlane(int side)
{
	...
	double magnitude = sqrt( frustum[side][A]*frustum[side][A] + frustum[side][B]*frustum[side][B] + frustum[side][C]*frustum[side][C] );
...
void Frustum::CalculateFrustum()
{
	...
	double   clip[16]; // This will hold the clipping planes
...
bool Frustum::SphereInFrustum( double x, double y, double z, double radius )
{
...
bool Frustum::CubeInFrustum( double x, double y, double z, double size )
{
